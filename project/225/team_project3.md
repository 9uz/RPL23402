Instruksi Proyek: "Public Data Format Handler"
- Buat pipeline data untuk proyek anda
- Sesuaikan kode berikut sesuai dengan proyek anda
- Simapn hasil data dalam bentuk csv
